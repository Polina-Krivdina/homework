...
//1. Повторяющийся код для подключения к базе данных: Каждое действие (создание, обновление, удаление) имеет повторяющийся
// код для создания подключения к базе данных.
//2. Повторяющийся SQL-запрос для пользователей: Методы для работы с пользователями имеют очень похожие запросы и обработку.
//   KISS (Keep It Simple, Stupid)
//1. Методы имеют слишком много обязанностей: Каждый метод взаимодействует с базой данных и обрабатывает данные, что делает
// код сложным для понимания и сопровождения.
//2. Использование магических строк: SQL-запросы встроены непосредственно в методы, что затрудняет их обновление и управление.
//   YAGNI (You Ain't Gonna Need It)
//1. Избыточные методы и функционал: Например, метод cp (изменение пароля) и cur (изменение роли пользователя) могут быть
// объединены с другими методами обновления, если они используются редко.
